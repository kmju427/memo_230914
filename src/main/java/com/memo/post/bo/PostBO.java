...
public class PostBO {
	...
	// input : userId(로그인된 사람), prevId, nextId / output : List<Post>
	...
	// 다음 페이지의 마지막인지 확인
	// input : userId, nextId / output : boolean
	...
	// input : userId, userLoginId, subject, content, file / output : X
