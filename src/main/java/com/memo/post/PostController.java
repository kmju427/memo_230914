...
public class PostController {
	...
	/**
	 * 글 목록 화면(로그인된 사람) - http://localhost/post/post-list-view
	 * @param prevIdParam
	 * @param nextIdParam
	 * @param model
	 * @param session
	...
	public String postListView(
		...
		if (postList.isEmpty() == false) {
			...
			prevId = postList.get(0).getId(); // 리스트의 첫 번째 글 번호
	...
	/**
	 * 글 쓰기 화면 - http://localhost/post/post-create-view
	 * @param model
	 * @return
	 */
	...
	/**
	 * 글 상세 화면 - http://localhost/post/post-detail-view?postId=?
	 * @param postId
	 * @param model
	 * @param session
	 * @return
